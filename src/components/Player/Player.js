...
function Player(props) {
  ...
  return (
    <div>
      <audio src="./music/dream.mp3" controls></audio>
    </div>
    // <Card
    //   sx={{
    //     zIndex: 10,
    ...
    //       </Typography>
    //     </CardContent>
    //     <audio ref={audioEl} src={props.songs[props.currentSong].src}></audio>
    //     <Box sx={{ display: "flex", alignItems: "center", pl: 1, pb: 1 }}>
    //       <IconButton aria-label="previous" onClick={() => skipSong(false)}>
    //         <SkipPreviousIcon />
    //       </IconButton>
    //       <IconButton onClick={playPause} aria-label="play/pause">
